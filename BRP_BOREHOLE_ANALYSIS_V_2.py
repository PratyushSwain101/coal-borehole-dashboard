...
with tab_litho_log:
    ...
    with col2: reference_seam = st.selectbox("2. Select Reference Seam for Alignment:", seam_list_with_none, key='corr_reference_seam', help="Select 'None' for true elevation view. Select a seam to flatten the plot on that seam's floor.")
